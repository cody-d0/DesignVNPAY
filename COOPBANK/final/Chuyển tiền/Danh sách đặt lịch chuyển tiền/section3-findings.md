...
| | |
|---|---|
| **Ảnh minh họa** | ![Trạng thái chỉ dùng màu](ui/calendar.png) |
...
| | |
|---|---|
| **Ảnh minh họa** | ![Xác nhận thiếu context](ui/popup.png) |
...
| | |
|---|---|
| **Ảnh minh họa** | ![OTP thiếu ngữ cảnh hành động](ui/popup-2.png) |
...
| | |
|---|---|
| **Ảnh minh họa** | ![Trạng thái trống thiếu hướng dẫn](ui/manage-2.png) |
...
| | |
|---|---|
| **Ảnh minh họa** | ![Bộ lọc thiếu giá trị mặc định](ui/filter-2.png) |
...
| | |
|---|---|
| **Ảnh minh họa** | ![Vùng chạm biểu tượng nhỏ](ui/calendar.png) |
...
| | |
|---|---|
| **Ảnh minh họa** | ![Phản hồi thành công thiếu chi tiết](ui/manage.png) |
...
| | |
|---|---|
| **Ảnh minh họa** | ![Dữ liệu lịch sử thiếu nhất quán](ui/list.png) |
...
| ID | Tên vấn đề | Severity | Heuristic | Màn hình |
|---|---|---|---|---|
| UXP-001 | Trạng thái chỉ phân biệt bằng màu, thiếu biểu tượng | 🔴 Critical | Nielsen #1 | Danh sách |
| UXP-002 | Hộp thoại xác nhận thiếu thông tin giao dịch | 🔴 Critical | Nielsen #5 | Chi tiết |
| UXP-003 | OTP thiếu ngữ cảnh hành động | 🟠 Major | Nielsen #1 | Chi tiết |
| UXP-004 | Trạng thái trống thiếu hình minh họa và nút hành động | 🟠 Major | Nielsen #10 | Quản lý |
| UXP-005 | Bộ lọc thiếu giá trị mặc định và kiểm tra | 🟠 Major | Nielsen #5 | Bộ lọc |
| UXP-006 | Vùng chạm biểu tượng lọc nhỏ hơn chuẩn | 🟡 Minor | Nielsen #7 | Danh sách |
| UXP-007 | Phản hồi thành công thiếu thông tin giao dịch | 🟡 Minor | Nielsen #1 | Quản lý |
| UXP-008 | Dữ liệu giao dịch hiển thị không nhất quán | 🟡 Minor | Nielsen #4 | Chi tiết |
