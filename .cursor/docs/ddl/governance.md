...
- .cursor/rules/comp-extraction.mdc, pdr-component-pipeline.mdc
- .cursor/agents/prd-full-pipeline.md
- .cursor/skills/comp-extraction/SKILL.md, figma-to-prd-md/SKILL.md, screen-count-extraction/SKILL.md

---

## Quality gates (chạy tay sau khi sửa .cursor/docs/ddl/)

1. **Term consistency:** `rg "design database|design DB" .cursor/docs/ddl/` → 0 matches.
2. **Anchor compatibility:** `rg "Thiết kế Database" .cursor/rules/ .cursor/skills/ .cursor/agents/` → đầy đủ như trước.
