...
screen_inventory = {           // design_data_layer: L2 (Advanced Figma); components[] và flow_graph feed vào L3 augmentation
  ...
  // Schema canon + mở rộng: .agents/docs/ddl/glossary.md § Screen boundaries schema
