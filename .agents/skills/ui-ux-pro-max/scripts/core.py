...
CSV_CONFIG = {
    ...
    "ux": {
        ...
        "output_cols": ["Category", "Issue", "Platform", "Description", "Do", "Don't", "Code Example Good", "Code Example Bad", "Severity", "ux_law_ref"]
    },
    "ux_laws": {
        "file": "ux-laws.csv",
        "search_cols": ["law_name", "statement", "keywords", "category"],
        "output_cols": ["law_id", "law_name", "author_or_source", "statement", "keywords", "category"]
    },
    "typography": {
        "file": "typography.csv",
